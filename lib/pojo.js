...
// Terminal
      {
        sassvar: "@terminal-backgroundColor",
        value: value.newValue.terminal.backgroundColor.toRGBAString(),
      },
      {
        sassvar: "@terminal-backgroundValue",
        value: value.newValue.terminal.backgroundValue,
      },
      {
        sassvar: "@terminal-textColor",
        value: value.newValue.terminal.textColor.toRGBAString(),
      },
      {
        sassvar: "@terminal-cursorColor",
        value: value.newValue.terminal.cursorColor.toRGBAString(),
      },
    ]
  }
}
