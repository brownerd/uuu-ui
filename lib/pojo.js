...
// @settings-bg-style: solid;
// @settings-nav: horizontal;
// @settings-border: true;


// All config settings to update sass variables
...
// atom.config.set('uuu-ui.settingsPage.background, 'pinstripe')
// atom.config.set('uuu-ui.settingsPage.nav, 'vertical')
// atom.config.set('uuu-ui.settingsPage.border, 'false')
